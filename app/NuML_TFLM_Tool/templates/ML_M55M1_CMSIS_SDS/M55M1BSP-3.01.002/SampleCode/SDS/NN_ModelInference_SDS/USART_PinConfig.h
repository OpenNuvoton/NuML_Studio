...
* @version  V1.00
* @brief    RTE Device Configuration for Nuvoton M55M1 USART
*
...
#define RTE_USART6_TX_ID                6
    ...
    #define RTE_SET_USART6_TX_PIN()         SET_UART6_TXD_PE14()
		#define RTE_CLEAR_USART6_TX_PIN()       SET_GPIO_PE14()
...
#define RTE_USART6_RX_ID                7
    ...
    #define RTE_SET_USART6_RX_PIN()         SET_UART6_RXD_PE15()
		#define RTE_CLEAR_USART6_RX_PIN()       SET_GPIO_PE15()
...
#define RTE_USART6_CTS_ID               0
    ...
    #define RTE_SET_USART6_CTS_PIN()
		#define RTE_CLEAR_USART6_CTS_PIN()
...
#define RTE_USART6_RTS_ID               0
    ...
    #define RTE_SET_USART6_RTS_PIN()
		#define RTE_CLEAR_USART6_RTS_PIN()
