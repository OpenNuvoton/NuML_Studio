...
)
{
    ...
    //pi16LPPDMAPingPoneBuf0 = calloc(1, (u32BlockSamples * u32Channels * sizeof(int16_t)) + (LPPDMA_BUF_ALIGH - 1));
    //pi16LPPDMAPingPoneBuf1 = calloc(1, (u32BlockSamples * u32Channels * sizeof(int16_t)) + (LPPDMA_BUF_ALIGH - 1));
    ...
    //pi16AudioInBuf = calloc(u32BlockSamples * u32BlockCounts * u32Channels, sizeof(int16_t));
    ...
    s_sLPPDMA_DMIC_SCT[0].DA = (uint32_t)(u32LPPDMAPingPoneBuf0_Aligned);
    ...
    s_sLPPDMA_DMIC_SCT[1].DA = (uint32_t)(u32LPPDMAPingPoneBuf1_Aligned);
