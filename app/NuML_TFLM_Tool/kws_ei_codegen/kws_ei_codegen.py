"""
KwsEICodegen is a class designed to facilitate the generation and modification of code files 
...
class KwsEICodegen:
    ...
    def update_proj_files(self):
        ...
        search_text = 'tflite_learn_719893_10_compiled.cpp'
