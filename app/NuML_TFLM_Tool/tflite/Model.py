...
def ModelAddOperatorCodes(builder, operatorCodes): builder.PrependUOffsetTRelativeSlot(
...
def ModelAddSubgraphs(builder, subgraphs): builder.PrependUOffsetTRelativeSlot(
...
def ModelAddDescription(builder, description): builder.PrependUOffsetTRelativeSlot(
...
def ModelAddBuffers(builder, buffers): builder.PrependUOffsetTRelativeSlot(
...
def ModelAddMetadataBuffer(builder, metadataBuffer): builder.PrependUOffsetTRelativeSlot(
...
def ModelAddMetadata(builder, metadata): builder.PrependUOffsetTRelativeSlot(
...
def ModelAddSignatureDefs(builder, signatureDefs): builder.PrependUOffsetTRelativeSlot(
...
def ModelStartSignatureDefsVector(
    builder, numElems): return builder.StartVector(4, numElems, 4)
