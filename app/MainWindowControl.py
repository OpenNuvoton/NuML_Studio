...
class myMainWindow(QMainWindow, Ui_MainWindow):
    """
    This class represents the main window of the application, inheriting from QMainWindow and Ui_MainWindow.
    ...
    def __init__(self):
        ...
        # clear textEdit
        self.pushButton_2.clicked.connect(lambda: self.clear_text_edit(self.textEdit_2))
        self.pushButton_3.clicked.connect(lambda: self.clear_text_edit(self.textEdit_3))
        ...
        self.populate_deployed_application()
        self.show_textedit_out_path_default()
    ...
    def on_tab_changed(self, index):
        """
        Handles the event when the tab is changed in the tab widget.
        """
    ...
    def populate_deployed_application(self):
        """
        Populates the comboBox_6 widget with a list of deployed applications.
        """
        applications = [item[0] for item in deployed_application_list]
        self.comboBox_6.addItems(applications)
    ...
    def on_firmware_selected_cam(self, selected_item):
        ...
        if selected_item == "Image":
            ...
            self.textEdit_serialPort_2.setDisabled(True)
            self.textEdit_Baudrate_2.setDisabled(True)
            ...
            self.textEdit_serialPort_2.setDisabled(False)
            self.textEdit_Baudrate_2.setDisabled(False)
    ...
    def show_textedit_out_path_default(self):
        """
        Sets the default output path in the text edit widget.
        """
        default_dir_name = "gen_proj_ml"
        self.textEdit_8.setPlainText(os.path.join(r'C:/', default_dir_name))
    ...
    def execute_numltool(self):
        ...
        arena_size = self.textEdit_9.toPlainText()
